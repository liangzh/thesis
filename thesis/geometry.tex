...
events; the region covered by red tilted lines corresponds to small traveling length, but it
...
$d<0.25R_{0}$ and $d>1.5R_{0}$ are marked by red tilted lines and blue crossings, respectively.}
\label{fig:distBimp}
\end{center}
\end{figure}
...
{Correlation between the impact parameter in \eA\ collision and evaporated protons or forward charged particles.
}
