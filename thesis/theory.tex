...
$Q^{2}$ and $x_{Bj}$ determine the resolution power of exchanged virtual photon. With large momentum transfer \qsq, we are allowed to resolve smaller objects
...
Although the parton model is shown to be successful in describing a lot of
...
\begin{figure*}
	...
	\caption[Feynman diagrams for the DIS processes at $\mathcal{O}(\alpha_{s}^{0})$ and $\mathcal{O}(\alpha_{s}^{1})$]{Feynman diagrams for the hard processes 
...
\begin{figure}
\centering
\includegraphics[width=1.0\textwidth]{plots/chpt2/virtual_correction.png}
\caption[Feynman diagrams of virtual corrections to LO DIS] {
