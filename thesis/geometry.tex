...
\subfigure[]{ 
\centering
\includegraphics[width=0.45\columnwidth,keepaspectratio]{plots/chpt7/tau9_neutron_travel_distance_corre.eps} \label{fig:distCorre} 
}
\quad
\subfigure[]{ 
\centering
\includegraphics[width=0.45\columnwidth,keepaspectratio]{plots/chpt7/tau9_neutron_bimpact_corre.eps} \label{fig:bimpCorre} 
}
...
\subfigure[]{ 
\centering
\includegraphics[width=0.45\columnwidth,keepaspectratio]{plots/chpt7/tau9_mostCentral_dist.eps} \label{fig:travelConstrain_central} 
}
\quad
\subfigure[]{ 
\centering
\includegraphics[width=0.45\columnwidth,keepaspectratio]{plots/chpt7/tau9_mostCentral_bimpact.eps} \label{fig:bimpConstrain_central} 
}
